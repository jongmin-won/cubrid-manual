...
Java 저장 함수에 대한 정보이며 unique_name에 대한 인덱스가 생성되어 있다.

+---------------------+---------------------------------------+-------------------------------------------+
| 속성명              | 데이터 타입                           | 설명                                      |
+=====================+=======================================+===========================================+
| unique_name         | VARCHAR(255)                          | 스키마명을 포함하는 SP 이름               |
+---------------------+---------------------------------------+-------------------------------------------+
...
+---------------------+---------------------------------------+-------------------------------------------+
| pkg_name            | VARCHAR(255)                          | PACKAGE 이름                              |
+---------------------+---------------------------------------+-------------------------------------------+
| is_system_generated | INTEGER                               | 0 - 내장 SP 1 - 사용자 정의 SP            |
+---------------------+---------------------------------------+-------------------------------------------+
| directive           | INTEGER                               | 0 - AUTHID OWNER + NOT DETERMINISTIC      |
|                     |                                       | 1 - AUTHID CALLER + NOT DETERMINISTIC     |
|                     |                                       | 2 - AUTHID OWNER + DETERMINISTIC          |
|                     |                                       | 3 - AUTHID CALLER + DETERMINISTIC         |
+---------------------+---------------------------------------+-------------------------------------------+
| target_class        | VARCHAR(1024)                         | 실행될 Java 클래스 이름                   |
+---------------------+---------------------------------------+-------------------------------------------+
| target_method       | VARCHAR(1024)                         | 실행될 Java 메서드 이름                   |
+---------------------+---------------------------------------+-------------------------------------------+
| owner               | db_user                               | 소유자                                    |
+---------------------+---------------------------------------+-------------------------------------------+
...
Java 저장 함수 인자에 대한 정보이며 sp_of에 대한 인덱스가 생성되어 있다.

+---------------------+-----------------------+---------------------------------+
| 속성명              | 데이터 타입           | 설명                            |
+=====================+=======================+=================================+
| sp_of               | _db_stored_procedure  | SP 인자가 속한 클래스           |
+---------------------+-----------------------+---------------------------------+
| pkg_name            | VARCHAR(255)          | PACKAGE 이름                    |
+---------------------+-----------------------+---------------------------------+
...
+---------------------+-----------------------+---------------------------------+
| default_value       | VARCHAR(255)          | 매개변수 기본 값                |
+---------------------+-----------------------+---------------------------------+
| is_optional         | INTEGER               | 0 - default_value 미사용        |
|                     |                       | 1 - default_value 사용          |
+---------------------+-----------------------+---------------------------------+
...
PL/CSQL 저장 함수에 대한 정보이며 name에 대한 인덱스가 생성되어 있다.

+----------------------+-----------------------+---------------------------------+
| 속성명               | 데이터 타입           | 설명                            |
+======================+=======================+=================================+
| name                 | VARCHAR(1024)         | PL/CSQL 이름                    |
+----------------------+-----------------------+---------------------------------+
| created_time         | VARCHAR(16)           | PL/CSQL 생성 시간               |
+----------------------+-----------------------+---------------------------------+
| owner                | db_user               | 소유자                          |
+----------------------+-----------------------+---------------------------------+
| is_static            | INTEGER               | 매개변수 이름                   |
+----------------------+-----------------------+---------------------------------+
| is_system_generated  | INTEGER               | 0 - 내장 SP 1 - 사용자 정의 SP  |
+----------------------+-----------------------+---------------------------------+
| stype                | INTEGER               | ??                              |
+----------------------+-----------------------+---------------------------------+
| scode                | VARCHAR(1073741823)   | PL/CSQL 생성 쿼리 원본          |
+----------------------+-----------------------+---------------------------------+
| otype                | INTEGER               | ??                              |
+----------------------+-----------------------+---------------------------------+
| ocode                | VARCHAR (1073741823)  | 컴파일                          |
+----------------------+-----------------------+---------------------------------+
...
+-------------------+----------------------+-------------------------------------------------+
| authid            | VARCHAR(16)          | 저장 함수의 실행 권한 (기본 값 OWNER(DEFINER))  |
+-------------------+----------------------+-------------------------------------------------+
| is_deterministic  | VARCHAR(3)           | DETERMINISTIC이면 ‘YES’, 그렇지 않으면 ‘NO’     |
+-------------------+----------------------+-------------------------------------------------+
| target            | VARCHAR(4096)        | 실행될 Java 메서드 이름                         |
+-------------------+----------------------+-------------------------------------------------+
| owner             | VARCHAR(256)         | 소유자                                          |
+-------------------+----------------------+-------------------------------------------------+
| code              | VARCHAR(1073741823)  | PL/CSQL 생성 쿼리 원본                          |
+-------------------+----------------------+-------------------------------------------------+
| comment           | VARCHAR(1024)        | SP 설명                                         |
+-------------------+----------------------+-------------------------------------------------+
...
+----------------+----------------+---------------------------------------------------+
| is_optional    | VARCHAR(3)     | default value가 있으면 ‘YES’, 그렇지 않으면 ‘NO’  |
+----------------+----------------+---------------------------------------------------+
| default_value  | VARCHAR(255)   | 매개변수 기본 값                                  |
+----------------+----------------+---------------------------------------------------+
| comment        | VARCHAR(1024)  | 매개변수 설명                                     |
